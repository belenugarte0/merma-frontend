...
export const ViewClassificModal = ({ orders }: Props) => {
              ...
              <ModalBody>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <Input
                    ...
                    variant="bordered"                    
                    isReadOnly
                    defaultValue={orders.client_cod}
                    labelPlacement="outside"
                    className="w-full"
                  />
                  <Input
                    ...
                    variant="bordered"                    
                    isReadOnly
                    defaultValue={orders.production_date}
                    labelPlacement="outside"
                    className="w-full"
                  />
